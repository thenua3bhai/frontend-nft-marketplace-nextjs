...
export default function NFTBox({ price, nftAddress, tokenId, marketplaceAddress, seller }) {
  ...
  async function updateUI() {
    ...
    if (tokenURI) {
      ...
      //this replaced link also not working from ipfs now 503 error is coming..so we are using currently nft.storage given link,which is working,and for in tokenUri and image link in json both place we inserted that for now until ipfs fix their gateway server
